  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-slate-50 dark:bg-zinc-950 p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 animate-pulse">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 p-5 rounded-2xl space-y-2">
      ...
      <div className="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 p-6 rounded-2xl flex-1 flex flex-col space-y-4 animate-pulse">
        <div className="h-4 w-64 bg-slate-200 dark:bg-zinc-800 rounded-lg"></div>
        <div className="h-3 w-96 bg-slate-200 dark:bg-zinc-800 rounded"></div>

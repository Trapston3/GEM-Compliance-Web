...
async function run() {
  ...
  // Take screenshot of mobile email drafting after fix
  await page.screenshot({ path: 'mobile_email_after.png', fullPage: true });
  console.log('Saved mobile_email_after.png');
